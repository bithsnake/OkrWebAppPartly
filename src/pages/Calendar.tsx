...
import CalendarRow from "../components/CalendaRow";
import IPage from "../interfaces/componentinterfaces";

export interface CalendarProps {}

const Calendar: React.FC<IPage & CalendarProps> = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-tr from-personal-900 w-screen h-screen fixed">
        <div className="md:shadow-lg md:rounded p-4 bg-white dark:bg-gray-700 md:w-96 mx-4 md:mx-auto mt-16 2xl:w-auto 2xl:h-96 2xl:m-96">
          <div className="w-full rounded">
            ...
            <div className="-mx-2">
              <table className="w-full dark:text-white">
                <thead>
                  <tr key={0}>
                    <th key={1} className="py-3 px-2 md:px-3 ">S</th>
                    <th key={2} className="py-3 px-2 md:px-3 ">M</th>
                    <th key={3} className="py-3 px-2 md:px-3 ">T</th>
                    <th key={4} className="py-3 px-2 md:px-3 ">W</th>
                    <th key={5} className="py-3 px-2 md:px-3 ">T</th>
                    <th key={6} className="py-3 px-2 md:px-3 ">F</th>
                    <th key={7} className="py-3 px-2 md:px-3 ">S</th>
                  </tr>
                </thead>
                <tbody>
                  <tr key={8}>
